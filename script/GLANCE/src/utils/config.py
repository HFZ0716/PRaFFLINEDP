...
PROJECT_RELEASE_LIST=[
    ...
    'amq-5.10.0',
    'amq-5.11.0',
    'amq-5.12.0', 'amq-5.14.0', 'amq-5.15.0',
    'bookkeeper-4.0.0',
    'bookkeeper-4.2.0',
    'bookkeeper-4.4.0',
    'calcite-1.6.0', 'calcite-1.8.0', 'calcite-1.11.0',
    'calcite-1.13.0',
    'calcite-1.15.0',
    'calcite-1.16.0', 'calcite-1.17.0', 'calcite-1.18.0',
    'cassandra-0.7.4', 'cassandra-0.8.6',
    'cassandra-1.0.9',
    'cassandra-1.1.6',
    'cassandra-1.1.11', 'cassandra-1.2.11',
    'flink-1.4.0', 'flink-1.6.0',
    'groovy-1.0', 'groovy-1.5.5', 'groovy-1.6.0', 'groovy-1.7.3', 'groovy-1.7.6', 'groovy-1.8.1', 'groovy-1.8.7',
    'groovy-2.1.0', 'groovy-2.1.6',
    'groovy-2.4.4',
    'groovy-2.4.6',
    'groovy-2.4.8', 'groovy-2.5.0', 'groovy-2.5.5',
    'hbase-0.94.1',
    'hbase-0.94.5',
    'hbase-0.98.0', 'hbase-0.98.5', 'hbase-0.98.11',
    'hive-0.14.0', 'hive-1.2.0',
    'hive-2.0.0',
    'hive-2.1.0',
    'ignite-1.0.0',
    'ignite-1.4.0',
    'ignite-1.6.0',
    'log4j2-2.0', 'log4j2-2.1', 'log4j2-2.2', 'log4j2-2.3', 'log4j2-2.4', 'log4j2-2.5',
    'log4j2-2.6',
    'log4j2-2.7',
    ...
    'mahout-0.4',
    'mahout-0.5',
    'mahout-0.6', 'mahout-0.7', 'mahout-0.8',
    'mng-3.0.0',
    'mng-3.1.0','mng-3.2.0',
    'mng-3.3.0', 'mng-3.5.0', 'mng-3.6.0',
    'nifi-0.4.0',
    'nifi-1.2.0','nifi-1.5.0','nifi-1.8.0',
    'nutch-1.1', 'nutch-1.3', 'nutch-1.4', 'nutch-1.5', 'nutch-1.6', 'nutch-1.7', 'nutch-1.8', 'nutch-1.9',
    'nutch-1.10','nutch-1.12',
    'nutch-1.13', 'nutch-1.14', 'nutch-1.15',
    'storm-0.9.0', 'storm-0.9.3',
    'storm-1.0.0', 'storm-1.0.3', 'storm-1.0.5',
    'tika-0.7', 'tika-0.8', 'tika-0.9', 'tika-0.10', 'tika-1.1',
    'tika-1.3', 'tika-1.5',
    'tika-1.7',
    'tika-1.10',
