...
all_train_releases = {
    'ambari': 'ambari-1.2.0','amq': 'amq-5.0.0', 'bookkeeper': 'bookkeeper-4.0.0',
                      'calcite': 'calcite-1.6.0','cassandra':'cassandra-0.7.4',
                      'groovy': 'groovy-1.0', 'hbase':'hbase-0.94.1','hive': 'hive-0.14.0',
                      'ignite': 'ignite-1.0.0', 'log4j2': 'log4j2-2.0','mahout':'mahout-0.3',
                      'mng': 'mng-3.0.0','nifi': 'nifi-0.4.0',
                      'nutch': 'nutch-1.1',
                      'storm':'storm-0.9.0',
                      'tika':'tika-0.7', 'ww':'ww-2.0.0',
                      'zookeeper': 'zookeeper-3.4.6'
                      }

all_eval_releases = {
    'ambari': [ 'ambari-2.1.0', 'ambari-2.2.0', 'ambari-2.4.0', 'ambari-2.5.0', 'ambari-2.6.0',
               'ambari-2.7.0'],
    'amq': ['amq-5.1.0', 'amq-5.2.0', 'amq-5.4.0', 'amq-5.5.0', 'amq-5.6.0', 'amq-5.7.0', 'amq-5.8.0',
            'amq-5.9.0', 'amq-5.10.0', 'amq-5.11.0', 'amq-5.12.0', 'amq-5.14.0', 'amq-5.15.0'],
    'bookkeeper': [ 'bookkeeper-4.2.0', 'bookkeeper-4.4.0'],
    'calcite': [ 'calcite-1.8.0', 'calcite-1.11.0', 'calcite-1.13.0', 'calcite-1.15.0',
                'calcite-1.16.0', 'calcite-1.17.0', 'calcite-1.18.0'],
    'cassandra': [ 'cassandra-0.8.6', 'cassandra-1.0.9', 'cassandra-1.1.6', 'cassandra-1.1.11',
                  'cassandra-1.2.11', ],
    'groovy': [ 'groovy-1.5.5', 'groovy-1.6.0', 'groovy-1.7.3', 'groovy-1.7.6', 'groovy-1.8.1',
    ...
    'log4j2': [ 'log4j2-2.1', 'log4j2-2.2', 'log4j2-2.3', 'log4j2-2.4', 'log4j2-2.5', 'log4j2-2.6',
    ...
    'nutch': [ 'nutch-1.3', 'nutch-1.4', 'nutch-1.5', 'nutch-1.6', 'nutch-1.7', 'nutch-1.8', 'nutch-1.9',
              'nutch-1.10', 'nutch-1.12', 'nutch-1.13', 'nutch-1.14', 'nutch-1.15'],
    'storm': [ 'storm-0.9.3', 'storm-1.0.0', 'storm-1.0.3', 'storm-1.0.5'],
    'tika': [ 'tika-0.8', 'tika-0.9', 'tika-0.10', 'tika-1.1', 'tika-1.3', 'tika-1.5', 'tika-1.7',
             'tika-1.10', 'tika-1.13', 'tika-1.15', 'tika-1.17'],
    'ww': [ 'ww-2.0.5', 'ww-2.0.10', 'ww-2.1.1', 'ww-2.1.3', 'ww-2.1.7', 'ww-2.2.0', 'ww-2.2.2', 'ww-2.3.1',
...
all_releases = {
    ...
    'nutch': ['nutch-1.1', 'nutch-1.3', 'nutch-1.4', 'nutch-1.5', 'nutch-1.6', 'nutch-1.7', 'nutch-1.8', 'nutch-1.9','nutch-1.10', 'nutch-1.12', 'nutch-1.13', 'nutch-1.14', 'nutch-1.15'],
