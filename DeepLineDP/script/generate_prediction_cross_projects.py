...
intermediate_output_dir = 'Baseline-result/DeepLineDP/output/intermediate_output/DeepLineDP/cross-project/'
prediction_dir = 'Baseline-result/DeepLineDP/output/prediction/DeepLineDP/cross-project/'
